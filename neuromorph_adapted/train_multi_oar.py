...
from utils.utils import k_fold_split_train_val_test, ParametersBase
import sys
...
def train_main(fold_num):
    data_folder = "/home/ed/correspondence/data/custom_optim/"
    ...
    interpol = create_interpol(fused_dataset_train, dataset_val=fused_dataset_val, description=f"all_oars_custom_optim_fold{fold_num}", folder_weights_load=None)
    interpol.train()
